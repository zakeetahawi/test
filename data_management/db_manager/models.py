...
class DatabaseBackup(models.Model):
    ...
    created_at = models.DateTimeField(_('تاريخ الإنشاء'), auto_now_add=True)
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='db_manager_created_backups', verbose_name=_('تم الإنشاء بواسطة'))
...
class DatabaseImport(models.Model):
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='db_manager_created_imports', verbose_name=_('تم الإنشاء بواسطة'))
